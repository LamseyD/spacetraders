...
// GetShipCount returns the ShipCount field value if set, zero value otherwise.
func (o *Agent) GetShipCount() int32 {
	if o == nil || IsNil(o.ShipCount) {
		var ret int32
		return ret
	}
	return *o.ShipCount
...
// GetShipCountOk returns a tuple with the ShipCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetShipCount gets a reference to the given int32 and assigns it to the ShipCount field.
